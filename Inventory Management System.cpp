...
public:
    ...
    void intro()
    {
        ...
        cout << "\n\t\t*   Submitted by:       Safa Tariq                *";
        cout << "\n\t\t*   Submitted by:       Amna Amjad                *";
        cout << "\n\t\t*   ROLL NO.:           23021519-165              *";
        cout << "\n\t\t*   ROLL NO.:           23021519-146              *";
        cout << "\n\t\t*   Section:            A                         *";
        cout << "\n\t\t*=================================================*";
...
int main()
{
    ...
    inventory.intro();
    cout << endl << " Press any key to begin!           " << endl;
    cin >> ch;
    ...
    while (true)
    {
        ...
        else if (choice == 2)
        {
            ...
            if (managerName == correctName && managerPassword == correctPassword)
            {
                system("CLS");
                cout << endl << "                     ====================================================================" << endl;
                cout << endl << endl << " \t\t\t ------------ Welcome to the Manager Dashboard ------------" << endl << endl;
                cout << endl << "                     ====================================================================" << endl;
                int managerChoice;
                do
                {
                    cout << endl << endl << "                 MAIN MENU            " << endl;
                    cout << endl << "     1. View All Products ";
                    cout << endl << "     2. Add Product ";
                    cout << endl << "     3. Remove Product ";
                    cout << endl << "     4. Modify Product ";
                    cout << endl << "     5. Find Product ";
                    cout << endl << "     6. View Cart ";
                    cout << endl << "     7. Add data to File ";
                    cout << endl << "     8. Read data from File ";
                    cout << endl << "     9. Check for Restock ";
                    cout << endl << "     10. Exit " << endl;
                    cout << endl << "   Enter your choice: ";
                    while (true)
                    {
                        cout << endl;
                        if (cin >> managerChoice && managerChoice > 0)
                        {
                            break;
                        }
                        else
                    ...
                    case 2:
                        system("CLS");
                        cout << endl;
                        cout << endl << "   Enter no. of products to add:  ";
                        cin >> count;
                        for (int i = 0;i < count;i++)
                    ...
                    case 4:
                    {
                        ...
                        inventory.modifyProduct(productName, newName, newQuantity, newPrice);
                        break;
                    }
                    case 5:
                    {
                    ...
                    case 6:
                        system("CLS");
                        cout << endl;
                        cout << endl << "  Customer's Cart:   " << endl;
                        cart.viewCart();
                        break;
            ...
            {
                cout << endl << endl << " Invalid Input" << endl << " Access denied.";
            }

        }
        else if (choice == 3)
        {
            cout << endl << "  Exiting system. Goodbye!";
            break;
        }
        else
        {
